...
public final class ActivityTestBinding implements ViewBinding {
  ...
  private ActivityTestBinding(@NonNull LinearLayout rootView, @NonNull Button getLocationButton,
  ...
  public static ActivityTestBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.getLocationButton;
      Button getLocationButton = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ActivityTestBinding((LinearLayout) rootView, getLocationButton, imageContainer);
    }
